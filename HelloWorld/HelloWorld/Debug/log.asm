; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27048.0 
	...
	TITLE	V:\persistent\C++\HelloWorld\HelloWorld\log.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0P@NJMHKAMN@Initalized?5Log@		; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0P@NJMHKAMN@Initalized?5Log@
CONST	SEGMENT
??_C@_0P@NJMHKAMN@Initalized?5Log@ DB 'Initalized Log', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; File v:\persistent\c++\helloworld\helloworld\log.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __02177C08_log@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 5
	push	OFFSET ??_C@_0P@NJMHKAMN@Initalized?5Log@
